      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-8 text-sm">
            <div class="site-info">
              <a href="#"><span class="mai-call text-primary"></span>+19 7272727272</a>
            ...
            @if (Route::has('login'))
                @auth
                    @if(Auth::user()->is_admin)
                        <li class="nav-link">
                            <a class="btn btn-primary ml-lg-3" href="/home">Dashboard</a>
                        </li>
                    @else

                        <li class="nav-item">
                            <a class="nav-link" href="{{route('myAppointment')}}" style="background-color: greenyellow;color: white;">My Appointment</a>
                        </li>
                        <li class="nav-item">
  ...
  <div align="Center" style="padding: 70px;">
    ...
    @foreach($appointments as $apponitment)
      ...
      <td style="padding: 10px; color: white;">
        <form action="{{route('cancleAppointment',$apponitment->id)}}" method="POST">
          @csrf
          @method('DELETE')
          <button class="btn btn-danger" onclick="return confirm('Are You Sure To Cancle')">Cancle</button>
        </form>
      </td>
    </tr>
    @endforeach
